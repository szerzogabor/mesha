    ...
    <div className="rounded-lg border border-border-default overflow-hidden">
      ...
      >
        ...
        {(session.linkedPullRequest || session.prUrl) && (() => {
          ...
          return (
            <span className="shrink-0 inline-flex items-center rounded-full px-1.5 py-0.5 text-[10px] font-medium bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
              PR
            </span>
          );
        })()}
