package com.mesha.api.worker.observability;
...
/**
 * Central observability utility for worker execution within the backend-api service.
 *
 ...
 *
 * Service separation is logical: telemetry from worker responsibilities is
 * emitted by the backend-api runtime but scoped to worker operations.
 * When the worker is extracted back into its own service, this class moves with it.
 */
@Component
